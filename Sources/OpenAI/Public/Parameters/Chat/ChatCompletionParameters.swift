...
public struct ChatCompletionParameters: Codable {
    ...
    public enum ContentType: Codable {
      ...
      public init(from decoder: Decoder) throws {
        ...
        if let text = try? container.decode(String.self) {
          self = .text(text)
        } else if let contentArray = try? container.decode([MessageContent].self) {
      ...
      public enum MessageContent: Codable, Equatable, Hashable {
        ...
        public struct ImageDetail: Codable, Equatable, Hashable {
          public let url: URL
        ...
        public struct AudioDetail: Codable, Equatable, Hashable {
        ...
        public init(from decoder: Decoder) throws {
          ...
          case "text":
            ...
            self = .text(text)
          case "image_url":
            let imageDetail = try container.decode(ImageDetail.self, forKey: .imageUrl)
            self = .imageUrl(imageDetail)
          case "input_audio":
            let audioDetail = try container.decode(AudioDetail.self, forKey: .inputAudio)
            self = .inputAudio(audioDetail)
          default:
  ...
  public enum FunctionCall: Codable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
      ...
      {
        switch value {
        case CodingKeys.none.rawValue: self = .none
    ...
    public enum PredictionContent: Codable {
      ...
      public init(from decoder: Decoder) throws {
        ...
        if let text = try? container.decode(String.self) {
          ...
          self = .contentArray(parts)
        } else {
          throw DecodingError.typeMismatch(
            PredictionContent.self,
            DecodingError.Context(
              codingPath: container.codingPath,
              debugDescription: "Invalid prediction content"
            )
          )
        }
      }
  ...
  public init(from decoder: Decoder) throws {
    ...
    functions = try container.decodeIfPresent([ChatFunction].self, forKey: .functions)
    ...
    logitBias = try container.decodeIfPresent([Int: Double].self, forKey: .logitBias)
    ...
    maCompletionTokens = try container.decodeIfPresent(Int.self, forKey: .maCompletionTokens)
    n = try container.decodeIfPresent(Int.self, forKey: .n)
    modalities = try container.decodeIfPresent([String].self, forKey: .modalities)
    prediction = try container.decodeIfPresent(Prediction.self, forKey: .prediction)
